...
void ShowConsole()
{
	...
	//if(_console_inited)
	//	CON_StartDraw();
	//I don't know what this does or where it is defined.
}
...
void glutSwapBuffers(void) {
	...
	//}	
	//I don't know what these do or where they are defined.											//
...
int glutGet(GLenum type) {
	...
	switch(type)
	{
	case GLUT_SCREEN_WIDTH: retval = 640; break;
	case GLUT_SCREEN_HEIGHT: retval = 480; break;
...
void glutMainLoop(void){
	...
	LWP_CreateThread(&draw_thread, &glutThread, 0, NULL, 0, 67);
